...
Use the product filters to find products that still have unconfigured values, and set those by hand or with the [photo pass of AI setup](guides/ai-setup), which is on every plan.
